...
// create instance of blob class
blob = new Blob('#C09EFF');
  ...
  let mouseMove = function(e) {
    ...
    if(typeof angle == 'number') {
      ...
      if(nearestPoint) {
        ...
        strength = Math.sqrt((strength.x * strength.x) + (strength.y * strength.y)) * 1;
